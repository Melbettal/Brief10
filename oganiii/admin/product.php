		  ...
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   ...
				   <!-- <h4 class="box-link" id="btnAddProduct"><a href="manage_product.php">Ajouter un Produit</a> </h4> -->
				   <button class="site-btn" id="btnAddProduct" data-filter="*" data-toggle="modal" data-target="#addProductModal" style="margin-left: 800px;">
                                Ajouter un Porduit
                            </button>
				</div>
				<!-- <div class="card-body--">
            ...
            <div class="row">
                ...
                <!-- <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row featured__filter">
                        ...
                        // 
                        $produits = getAllDataFromTable('product');
                        $index = 0;
                        while ($row = $produits->fetch_assoc()) {
                            $prodId = $row["id"];
                            $prodName = $row["name"];
                            $prodCategId = $row["categories_id"];
                            $prodPrice = $row["price"];
                            $prodImage = $row["image"];
                            $categName = null;
                            $qt = $row["qty"];
